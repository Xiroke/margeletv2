...
import type { CreateApiPersonalGroupsOtherUserIdPostData, CreateApiPersonalGroupsOtherUserIdPostError, CreateApiSimpleGroupsPostData, CreateApiSimpleGroupsPostError, CreateMessageApiMessagesPostData, CreateMessageApiMessagesPostError, DeleteApiMessagesIdDeleteData, DeleteApiMessagesIdDeleteError, DeleteApiPersonalGroupsIdDeleteData, DeleteApiPersonalGroupsIdDeleteError, DeleteApiSimpleGroupsIdDeleteData, DeleteApiSimpleGroupsIdDeleteError, GetAccessTokenApiAuthTokenPostData, GetAccessTokenApiAuthTokenPostResponse, GetApiSimpleGroupsIdGetData, GetCursorMessagesByGroupApiMessagesCursorGroupIdGetData, GetCursorMessagesByGroupApiMessagesCursorGroupIdGetError, GetCursorMessagesByGroupApiMessagesCursorGroupIdGetResponse, GetLastMessagesByGroupApiMessagesLastGroupIdGetData, GetMeApiAuthMeGetData, GetMyGroupsApiPersonalGroupsMeGetData, GetMySimpleGroupsApiSimpleGroupsMeGetData, GetUsernamesByIdApiUsersUsernamesPostData, GetUsernamesByIdApiUsersUsernamesPostError, GetUsernamesByIdApiUsersUsernamesPostResponse, LoadAvatarApiUsersAvatarMeGetData, LoginApiAuthLoginPostData, LoginApiAuthLoginPostError, PingApiHealthcheckGetData, RegisterApiAuthRegisterPostData, RegisterApiAuthRegisterPostError, RegisterSchemasRouteRegisterSchemasGetData, ResendVerificationApiAuthResendVerificationPostData, ResendVerificationApiAuthResendVerificationPostError, UpdateApiMessagesIdPatchData, UpdateApiMessagesIdPatchError, UpdateApiPersonalGroupsIdPatchData, UpdateApiPersonalGroupsIdPatchError, UpdateApiSimpleGroupsIdPatchData, UpdateApiSimpleGroupsIdPatchError, UploadAvatarApiUsersAvatarMePostData, UploadAvatarApiUsersAvatarMePostError, VerifyApiAuthVerifyPostData, VerifyApiAuthVerifyPostError } from '../types.gen'

import { client as _heyApiClient } from '../client.gen'
import { createApiPersonalGroupsOtherUserIdPost, createApiSimpleGroupsPost, createMessageApiMessagesPost, deleteApiMessagesIdDelete, deleteApiPersonalGroupsIdDelete, deleteApiSimpleGroupsIdDelete, getAccessTokenApiAuthTokenPost, getApiSimpleGroupsIdGet, getCursorMessagesByGroupApiMessagesCursorGroupIdGet, getLastMessagesByGroupApiMessagesLastGroupIdGet, getMeApiAuthMeGet, getMyGroupsApiPersonalGroupsMeGet, getMySimpleGroupsApiSimpleGroupsMeGet, getUsernamesByIdApiUsersUsernamesPost, loadAvatarApiUsersAvatarMeGet, loginApiAuthLoginPost, type Options, pingApiHealthcheckGet, registerApiAuthRegisterPost, registerSchemasRouteRegisterSchemasGet, resendVerificationApiAuthResendVerificationPost, updateApiMessagesIdPatch, updateApiPersonalGroupsIdPatch, updateApiSimpleGroupsIdPatch, uploadAvatarApiUsersAvatarMePost, verifyApiAuthVerifyPost } from '../sdk.gen'
...
export const getCursorMessagesByGroupApiMessagesCursorGroupIdGetInfiniteOptions = (options: Options<GetCursorMessagesByGroupApiMessagesCursorGroupIdGetData>) => {
  return infiniteQueryOptions<GetCursorMessagesByGroupApiMessagesCursorGroupIdGetResponse, GetCursorMessagesByGroupApiMessagesCursorGroupIdGetError, InfiniteData<GetCursorMessagesByGroupApiMessagesCursorGroupIdGetResponse>, QueryKey<Options<GetCursorMessagesByGroupApiMessagesCursorGroupIdGetData>>, null | Pick<QueryKey<Options<GetCursorMessagesByGroupApiMessagesCursorGroupIdGetData>>[0], 'body' | 'headers' | 'path' | 'query'> | string>(
    // @ts-ignore
    {
      queryFn: async ({ pageParam, queryKey, signal }) => {
        // @ts-ignore
        const page: Pick<QueryKey<Options<GetCursorMessagesByGroupApiMessagesCursorGroupIdGetData>>[0], 'body' | 'headers' | 'path' | 'query'> = typeof pageParam === 'object'
          ? pageParam
          : {
              query: {
                cursor: pageParam,
