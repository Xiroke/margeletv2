...
export const getCursorMessagesByGroupApiMessagesGroupIdGetQueryKey = (options: Options<GetCursorMessagesByGroupApiMessagesGroupIdGetData>) => createQueryKey('getCursorMessagesByGroupApiMessagesGroupIdGet', options);

/**
 * Get Cursor Messages By Group
 */
export const getCursorMessagesByGroupApiMessagesGroupIdGetOptions = (options: Options<GetCursorMessagesByGroupApiMessagesGroupIdGetData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await getCursorMessagesByGroupApiMessagesGroupIdGet({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: getCursorMessagesByGroupApiMessagesGroupIdGetQueryKey(options)
    });
};
...
export const getCursorMessagesByGroupApiMessagesGroupIdGetInfiniteQueryKey = (options: Options<GetCursorMessagesByGroupApiMessagesGroupIdGetData>): QueryKey<Options<GetCursorMessagesByGroupApiMessagesGroupIdGetData>> => createQueryKey('getCursorMessagesByGroupApiMessagesGroupIdGet', options, true);

/**
 * Get Cursor Messages By Group
 */
export const getCursorMessagesByGroupApiMessagesGroupIdGetInfiniteOptions = (options: Options<GetCursorMessagesByGroupApiMessagesGroupIdGetData>) => {
    return infiniteQueryOptions<GetCursorMessagesByGroupApiMessagesGroupIdGetResponse, GetCursorMessagesByGroupApiMessagesGroupIdGetError, InfiniteData<GetCursorMessagesByGroupApiMessagesGroupIdGetResponse>, QueryKey<Options<GetCursorMessagesByGroupApiMessagesGroupIdGetData>>, string | null | Pick<QueryKey<Options<GetCursorMessagesByGroupApiMessagesGroupIdGetData>>[0], 'body' | 'headers' | 'path' | 'query'>>(
    // @ts-ignore
    {
        queryFn: async ({ pageParam, queryKey, signal }) => {
            // @ts-ignore
            const page: Pick<QueryKey<Options<GetCursorMessagesByGroupApiMessagesGroupIdGetData>>[0], 'body' | 'headers' | 'path' | 'query'> = typeof pageParam === 'object' ? pageParam : {
                query: {
                    cursor: pageParam
                }
            };
        ...
        queryKey: getCursorMessagesByGroupApiMessagesGroupIdGetInfiniteQueryKey(options)
    });
};
