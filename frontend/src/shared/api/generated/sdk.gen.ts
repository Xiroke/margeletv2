 ...
 */
export const getCursorMessagesByGroupApiMessagesGroupIdGet = <ThrowOnError extends boolean = false>(options: Options<GetCursorMessagesByGroupApiMessagesGroupIdGetData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetCursorMessagesByGroupApiMessagesGroupIdGetResponses, GetCursorMessagesByGroupApiMessagesGroupIdGetErrors, ThrowOnError>({
