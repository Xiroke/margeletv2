 ...
 */
export const getLatestMessagesByGroupApiMessagesGroupIdGet = <ThrowOnError extends boolean = false>(options: Options<GetLatestMessagesByGroupApiMessagesGroupIdGetData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetLatestMessagesByGroupApiMessagesGroupIdGetResponses, GetLatestMessagesByGroupApiMessagesGroupIdGetErrors, ThrowOnError>({
